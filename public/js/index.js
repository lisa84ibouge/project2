...
$('#submit').on('click',function(){
   ...
   $.post('/api/user', userInputs, function (data) {
      ...
      // });
         ...
         var myPanel = $(
            '<div class="card-block"><div class="card-title"><p>Name:'+data[i].name +'</p><button type="button" class="close" data-target="#'+i+'Panel" data-dismiss="alert"><span class="float-right"><i class="fa fa-remove"></i></span></button></div><p>City to visit '+data[i].city+' </p><p>Country to visit: '+data[i].country+' </p><img src="'+data[i].photo+'" class="rounded rounded-circle"width="100px"height="100px"></div></div>');
